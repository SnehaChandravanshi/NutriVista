    ...
    <div className='footer' id='footer'>
      <div className="footer-content">
        ...
        <div className="footer-content-right">
          <h2>GET IN TOUCH</h2>
          <ul>
            <li>Developed by: Sneha Chandravanshi</li>
            <li>Email: <a href="mailto:chandravanshisneha102@gmail.com">chandravanshisneha102@gmail.com</a></li>
          </ul>
          <button className="feedback-button" onClick={handleFeedbackClick}>Give Feedback</button>
        </div>
      </div>
      <hr />
      <p className="footer-copyright">Copyright 2026 © NutriVista.com - All Rights Reserved.</p>
    </div>
  );
}
